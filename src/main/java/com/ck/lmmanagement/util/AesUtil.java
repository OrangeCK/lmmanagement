...
public class AesUtil {
     ...
     * 密钥 (需要前端和后端保持一致)
     */
    private static final String KEY = "CkAndLimin@.1015";
    /**
     * 算法
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("URL加密后1：" + urlEncode);
        urlEncode = URLEncoder.encode(urlEncode,"UTF-8");
        System.out.println("URL加密后2：" + urlEncode);
        String urlDecode = URLDecoder.decode(urlEncode,"UTF-8");
        urlDecode = URLDecoder.decode(urlDecode,"UTF-8");
        System.out.println("URL解密后1：" + urlDecode);
        urlDecode = URLDecoder.decode(urlDecode,"UTF-8");
        System.out.println("URL解密后2：" + urlDecode);
        String decrypt = aesDecrypt(urlDecode, KEY);
